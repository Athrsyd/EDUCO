        ...
        <div className="min-h-screen bg-[#EDEAE4] flex flex-col pt-16" style={{ fontFamily: "'Poppins', sans-serif" }}>
          ...
          >
            ...
            <div className="flex items-center">
              <button
                onClick={() => navigate('/')}
                className="mr-2 md:mr-4 p-2 rounded-full hover:bg-black/5 transition-all duration-200 hover:scale-110 touch-target flex items-center justify-center"
                title="Kembali ke Home"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#48A111" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="opacity-70 hover:opacity-100">
                    ...
                    return (
                      <Link to="/siswa/misi">
                        ...
                        >
                          ...
                          {/* Arrow button */}
                          <div
                            className="flex items-center justify-center shrink-0 mr-2 md:mr-3 transition-colors duration-200"
                            style={{
