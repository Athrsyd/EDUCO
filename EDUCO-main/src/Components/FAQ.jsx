  ...
  return (
    <div className='flex items-start gap-5 py-10 px-10'>
      ...
      <div className="flex flex-col max-w-125">
        <div onClick={toggleOpen} className='flex flex-row justify-between items-center gap-4 bg-primary py-3 px-6 rounded-full cursor-pointer z-10'>
        ...
        <div className={`overflow-hidden max-w-115 transition-all duration-300 ${isOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
          <div className='bg-accent rounded-b-2xl px-6 pt-8 pb-6 -mt-5 ml-10 text-justify'>
